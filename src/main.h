...
enum StrRegister
{
    STA_SSID,      // 想連接的WIFI名稱{C3122}
    STA_PASSWORD,  // 想連接的WIFI密碼{000C3122,R,password}
...
enum ModbusRegister
{
    ...
    _MQTT_BROKER_URL,   // MQTT服務器網址{localhost.local}
    _MQTT_BROKER_PORT,  // MQTT端口{1833}
    _MQTT_CLIENT_NAME,  // MQTT客戶端名稱{}
    _MQTT_DELAYTIME,    // MQTT的loop時間(ms){100}
    _SOCKETIO_URL,       //SocketIO伺服器網址{localhost.local}
